...
5. **超时计入延迟**：超时请求按实际耗时计入 P95，不会被误判为“最快接口”。
...
接口性能排行 (按 P95 从慢到快)
┌──────┬──────┬────────────────┬──────────┬──────────┬────────┐
│ 排名 │ 方法 │ 路径           │ P95 (ms) │ P99 (ms) │ 成功率 │
├──────┼──────┼────────────────┼──────────┼──────────┼────────┤
│    1 │ GET  │ /info          │  3016.24 │  3016.44 │   0.0% │
│    2 │ POST │ /post/list     │    21.16 │    21.49 │   0.0% │
│    3 │ POST │ /user/register │    20.47 │    20.69 │   0.0% │
│  ... │ ...  │ ...            │      ... │      ... │    ... │
└──────┴──────┴────────────────┴──────────┴──────────┴────────┘
```
